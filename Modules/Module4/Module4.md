...
Evaluate the following code. Is the code written correctly? What would be the correct code?
 ...
 - Answer:The code is incorrect because it should have "", print("This message has a syntax error!"). The object churrigueresco is undefined
...
Expected:  The Number is 360
 ...
 - Answer:You must write the object as a variable not a text. It should be: 
 someNumber=360
...
print(f"The boy is {age}, he will go to {place}." )
